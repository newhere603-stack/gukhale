...
# ========================
# ROBUST SELL FLOW (Using Standard ConversationHandler with High Priority)
# ========================
...
sell_conv_handler = ConversationHandler(
    ...
    per_message=False,
    allow_reentry=True,
    block=True  # 🔥 Block=True karke ise high priority de di hai taaki message pehle yahin aaye!
)

application.add_handler(CommandHandler("pmarket", pmarket_command, block=False))
application.add_handler(sell_conv_handler, group=0)  # 🔥 group=0 par set karke sabse pehle execute hone ke liye rakha hai
