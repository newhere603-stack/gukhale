...
application.add_handler(MessageHandler(filters.Regex(re.compile(r'^\s*(cutiepie shop|cutepie shop|cutie pie shop)\s*$', re.IGNORECASE)), pmarket_command, block=False), group=0)
